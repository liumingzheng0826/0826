package com.jiyun.helloworld.wude.dao;
 ...
 * DAO for table "DATA".
*/
public class DataDao extends AbstractDao<Data, Integer> {
    ...
    public static class Properties {
        public final static Property Id = new Property(0, int.class, "Id", true, "Iiid");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DATA\" (" + //
                "\"Iiid\" INTEGER PRIMARY KEY NOT NULL ," + // 0: Id
                "\"NAME\" TEXT);"); // 1: name
    }
    ...
    @Override
    protected final Integer updateKeyAfterInsert(Data entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public Integer getKey(Data entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
